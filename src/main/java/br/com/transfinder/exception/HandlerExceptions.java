...
public class HandlerExceptions {
	...
	public ResponseEntity<StandardErrorSpring> validationException(ValidationException e, HttpServletRequest req) {

		StandardErrorSpring err = new StandardErrorSpring(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(),
				"Informações inválidas", Arrays.asList(), e.getMessage(), req.getRequestURI());
